  ...
  return (
    ...
    <Link
      ...
      className="group relative mt-8 flex gap-4 items-center justify-center rounded-full 
        ...
        border border-purple-400/20 z-10
      "
      style={{
    ...
    >
      <span className="relative z-10 font-cairo">تـواصــل معنــا الآن</span>
      ...
      <div className='relative w-12 h-12 sm:w-14 sm:h-14 flex justify-center items-center 
        ...
        shadow-lg
      '>
        <ArrowUpLeft className='w-6 h-6 sm:w-7 sm:h-7 text-purple-600 
          group-hover:text-violet-600 transition-colors duration-300' 
        />
      </div>
      
      {/* Glow effect on hover */}
      <div className="absolute inset-0 rounded-full bg-gradient-to-r from-violet-600 to-purple-600 
